...
public final class Entity
{
            ...
            EventScheduler scheduler)
    {
        ...
        if (openPt.isPresent()) {
            Entity ore = createOre(WorldModel.ORE_ID_PREFIX + id, openPt.get(),
                    WorldModel.ORE_CORRUPT_MIN + rand.nextInt(
                            WorldModel.ORE_CORRUPT_MAX - WorldModel.ORE_CORRUPT_MIN),
